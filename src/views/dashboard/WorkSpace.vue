...
export default class Workplace extends Vue {
  ...
  nickname!: string
  @State(state => state.user.welcome)
  welcome!: string
  ...
  created() {
    ...
    this.roleStr = this.roles
      .map(item => {
        return item.name
      })
      .toString()
    console.log()
    // this.roleStr = list.toString
  ...
  // methods
  getProjects() {
    this.$http.get('/list/search/projects').then((res: any) => {
      this.projects = res.result && res.result.data
      this.loading = false
    })
  }
  getActivity() {
    this.$http.get('/workplace/activity').then((res: any) => {
      this.activities = res.result
    })
  }
  getTeams() {
    this.$http.get('/workplace/teams').then((res: any) => {
  ...
  initRadar() {
    ...
    this.$http.get('/workplace/radar').then((res: any) => {
